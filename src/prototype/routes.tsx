...
export const ROUTES: Route[] = [
  {
    path: '/nav/minimal',
    title: 'Minimal',
    blurb: 'CSS scroll-snap + the scrollsnapchange event. Least code, modern platform.',
  ...
  },
  {
    path: '/nav/idiomatic',
    title: 'Idiomatic',
    blurb: 'IntersectionObserver on a centre line + scrollIntoView. The common pattern.',
    group: 'Panel navigation',
  ...
  },
  {
    path: '/nav/embla',
    title: 'Embla (FOSS)',
    blurb: 'Embla Carousel does snapping, dragging, and selected-snap tracking.',
    group: 'Panel navigation',
    element: <NavEmbla />,
  },
  {
